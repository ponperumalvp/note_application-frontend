...
import { createBussinessNote } from "../../Redux_thunk/noteSlice";
import { useNavigate } from "react-router-dom";
import { getItem } from "../../localStorage/getItem/getItem";

const CreateBussinessNotes = () => {
  ...
  const handleClick = async () => {
    ...
    await dispatch(createBussinessNote(newNotes));
...
export default CreateBussinessNotes;
